    ...
    <>
      ...
      <aside className="fixed left-0 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col gap-2.5">
        ...
        <a
          ...
          className="bg-[#1877F2] text-white shadow-xl hover:shadow-2xl rounded-r-2xl border-y border-r border-white/40 overflow-hidden transition-all duration-300 ease-out flex items-center p-2 group/fb"
          title="Visit Mousahi on Facebook"
        >
          {/* Facebook Icon Badge */}
          <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white shrink-0 group-hover/fb:rotate-12 transition-transform duration-300 shadow-inner">
            <Facebook className="w-6 h-6 fill-white text-[#1877F2]" />
          </div>

          {/* Expanded Info on Hover */}
          <div className="max-w-0 group-hover/fb:max-w-[220px] opacity-0 group-hover/fb:opacity-100 transition-all duration-300 ease-out whitespace-nowrap overflow-hidden flex flex-col justify-center pl-0 group-hover/fb:pl-3">
          ...
          <div className="max-w-0 group-hover/fb:max-w-[32px] opacity-0 group-hover/fb:opacity-100 transition-all duration-300 overflow-hidden flex items-center justify-center shrink-0 pr-1">
      ...
      <div className="md:hidden fixed bottom-6 left-4 z-40 flex flex-col gap-2">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#1877F2] text-white px-3.5 py-2 rounded-full shadow-xl flex items-center gap-2 text-xs font-bold border border-white/40"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-emerald-600 text-white px-3.5 py-2 rounded-full shadow-xl flex items-center gap-2 text-xs font-bold border border-white/40"
        >
